...
public class listennlearn extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        title.setText("IAU - Listen and Learn");
    ...
    private void worker(int i) {
        try {
            ...
            int contentPeriodPos = newscontent.length();
            if(newscontent.lastIndexOf(".")!=-1) {
                contentPeriodPos = newscontent.lastIndexOf(".");
            }
            System.out.println("processed news content: " + newscontent);
